...
export const projects: Project[] = [
  {
    ...
    role: "Full-stack",
    description:
      "Plataforma SaaS para educación diferencial que permite a los alumnos realizar actividades con un motor pedagógico basado en método Troncoso y ayudas graduadas. Diseño con minimización de datos alineado a la Ley 21.719 y seguridad multi-tenant a nivel de base de datos. En desarrollo activo (fase 2 de 6) · Ganador categoría Innovación en Mercado E (Santo Tomás). Nace de mi proyecto de título, validado con el Instituto Down de Concepción.",
    tags: ["REACT", "TYPESCRIPT", "SUPABASE", "POSTGRESQL"],
    featured: true,
    spotlight: true,
    href: "https://eduadapta.cl/",
